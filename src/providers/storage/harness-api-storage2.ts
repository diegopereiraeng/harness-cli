...
import { Harness, HarnessApiOptions2 } from '../harness/harness-api-client2'
import { StorageType, StorageProviderRef, StorageProvider } from './storage-provider2'
...
export class HarnessStorageProvider implements StorageProvider {
    ...
    type: StorageType
    initialized: boolean
    options: HarnessApiOptions2
    files: ConfigAsCodeFile[]

    constructor(options: HarnessApiOptions2, harnessClient?: Harness) {
    ...
    static createRef(opts: HarnessApiOptions2): StorageProviderRef {
        return {
